...
url = 'https://raw.githubusercontent.com/Adlibaari/Testing/main/PreprocessingDatasetSephora.csv'
...
def main():
    ...
    st.write(filtered_data.iloc[filtered_data.product_name == Product])
